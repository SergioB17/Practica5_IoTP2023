...
String serverPath = "http://api.openweathermap.org/data/2.5/weather?lat=20.6069&lon=-103.415629&appid=9097ae4f08f27ab882383d7027d35ddb&units=metric"; //El path que usaste en el web para la tem de la API - TODO el path con http

// ThingSpeak
uint32_t channelNumber = 2056570; // Tu channel ID number de thingspeak
const char *writeAPIKey = "QCG87GGCBJ7LTCNS"; // El API write de thingspeak
